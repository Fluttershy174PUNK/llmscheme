...
2. Открой `http://host:8080/editor` — страница-схема по умолчанию, или
   `http://host:8080/editor/<имя>?t=<token>`.
3. Рисуй узлы/связи, жми SAVE — уходит `PUT /api/scheme/<имя>` (tier S),
   ревизия и md/html обновляются на сервере.
4. 🎨 В канвасе: палитра фигур слева (клик — выбрать, клик по канвасу —
