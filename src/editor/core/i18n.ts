...
export const DICT = {
	en: {
		...
		connectHint:
			"connect: click a + port on the source, then a port on the target",
		...
		resetHint:
			"if you are locked out: stop the container, delete DATA_DIR/lightdb.json, and restart with ADMIN_PASSWORD=... in the env.",
		allProjects: "projects",
		allUsers: "users",
		typeToConfirm: "Type the name to confirm:",
		// console v3: project/scheme management + per-key mcp
		rename: "rename",
		duplicate: "duplicate",
		showMcpSchema: "show mcp schema",
		generateKey: "generate key",
		schemeWord: "scheme",
		projectWord: "project",
		newName: "new name",
		noProject: "no project",
		keySecretNote: "the key secret is shown only once at creation",
		cancel: "cancel",
		confirm: "confirm",
		input: "input",
		choose: "choose",
	...
	ru: {
		...
		resetHint:
			"если заперся: останови контейнер, удали DATA_DIR/lightdb.json и перезапусти с ADMIN_PASSWORD=... в окружении.",
		allProjects: "проекты",
		allUsers: "юзеры",
		typeToConfirm: "Набери имя для подтверждения:",
		// консоль v3: управление проектами/схемами + mcp по ключу
		rename: "переименовать",
		duplicate: "дублировать",
		showMcpSchema: "показать mcp схему",
		generateKey: "сгенерировать ключ",
		schemeWord: "схема",
		projectWord: "проект",
		newName: "новое имя",
		noProject: "без проекта",
		keySecretNote: "секрет ключа показывается только один раз при создании",
		cancel: "отмена",
